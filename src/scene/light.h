...
// TODO: Distinguish SphereLight from PointLight
...
//     float radius = 1.0f;                      // Radius of the sphere light

//     static SphereLight* CreateSphere(
//         const glm::vec3& pos, const glm::vec3& color = glm::vec3(1.0f),
//         float radius = 1.0f, float intensity = 1.0f
//     );
// };
